...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://y4diw6g2g3.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'Content-Type', 'Accept'], ['body']);
